...
#=============================================================================================================================
#=============================================================================================================================
# Функція виводу була строрена Тимофієм Багно

# Функція для виводу всіх студентів
def output_all_students(students_grades):
    print("Студнти:")
    
    students_grades = students_grades["students"]
    
    for students_numbers in students_grades:
        
        print(students_numbers)
        
        students = students_grades[students_numbers]
        
        field_name = list(students)
        field_val = list(students.values())

        print("Прізвище\t", field_val[0])
        print("Ім'я    \t", field_val[1])
        print("По батькові\t", field_val[2])
        print("Предмети\t", field_val[-1])
    
output_all_students(students_grades)
